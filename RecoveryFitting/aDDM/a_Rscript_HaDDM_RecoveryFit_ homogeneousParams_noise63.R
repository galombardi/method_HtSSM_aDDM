...
for (p in (1:length(d))){
  ...
  save(results,params,DataFit, file=file.path(main_folder,"results_HaDDM_homogParams_noise63_",toString(p), ".RData"))
  write.csv(suuum, file=file.path(main_folder,"results_HaDDM_homogParams_noise63_",toString(p),".csv"))
}
