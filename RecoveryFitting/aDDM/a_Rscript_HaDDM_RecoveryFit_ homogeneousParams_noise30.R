...
save(results,params,DataFit, file=file.path(main_folder,"results_HaDDM_homogParams_noise30_",toString(p), ".RData"))
write.csv(suuum, file=file.path(main_folder,"results_HaDDM_homogParams_noise30_",toString(p),".csv"))
}
